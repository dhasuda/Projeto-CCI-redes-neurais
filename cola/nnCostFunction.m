...
X3 = sigmoid(Theta2 * X21); % terminada a parte de definir os valores das funções

Y = zeros(size(X3)); % Y tem as mesmas dimensões de X3
...
erro2 = erro2(2:end, :); % temos q tirar a linha correspondente ao bias, que é constante e nao carrega erro
